      ...
      <div class="modal-content chat-modal" @click.stop>
        ...
        <div class="modal-body chat-body">
          <div class="chat-messages">
            <div v-for="(msg, idx) in chatMessages" :key="idx" :class="['chat-message', msg.self ? 'own' : '']"
              @mouseenter="msg.showTime = true" @mouseleave="msg.showTime = false" style="position: relative;">
              <div class="message-content">{{ msg.content }}</div>
              <!-- 悬停时显示时间 -->
              <div v-if="msg.showTime" class="msg-tooltip">
